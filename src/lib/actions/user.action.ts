...
export async function deleteUser(params: DeleteUserParams) {
  try {
    ...
    // Delete not only the user, but also the user's data / activity (questions, answers, comments) / etc.
...
export async function getAllUsers(params: GetAllUsersParams) {
  try {
    ...
    // Calculate the number of users to skip based
    // on the page number and page size
...
export async function getSavedQuestions(params: GetSavedQuestionsParams) {
  try {
    ...
    // Calculate the number of questions to skip based on the page number and
    // page size
    const skipAmount = (page - 1) * pageSize;
...
export async function getUserInfo(params: GetUserByIdParams) {
  try {
    ...
    // 👇 This [questionUpvotes] = destructured array
